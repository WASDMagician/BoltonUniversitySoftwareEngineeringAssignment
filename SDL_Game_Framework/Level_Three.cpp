...
void Level_Three::Setup()
{
	m_level_number = 3;
	//create areas
	AW_Sprite_Interface *area_one = new AW_Sprite_Interface("images/area5.png", 1, 1);
	AW_Sprite_Interface *area_two = new AW_Sprite_Interface("images/area3.png", 1, 1);
	AW_Sprite_Interface *area_three = new AW_Sprite_Interface("images/StartingArea.png", 1, 1);
	AW_Sprite_Interface *area_four = new AW_Sprite_Interface("images/area4.png", 1, 1);
	AW_Sprite_Interface *area_five = new AW_Sprite_Interface("images/area1.png", 1, 1);
